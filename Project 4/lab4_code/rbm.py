...
class RestrictedBoltzmannMachine():
    ...
    def cd1(self,visible_trainset, n_iterations=10000):
	    ...
	    # [TODO TASK 4.1] run k=1 alternating Gibbs sampling : v_0 -> h_0 ->  v_1 -> h_1.
            ...
            p_v_h, v = self.get_v_given_h(p_h_v)
            v_1 = v.copy()

            p_h_v, h = self.get_h_given_v(p_v_h)
            h_1 = h.copy()
    ...
    def get_v_given_h(self,hidden_minibatch):
        ...
        if self.is_top:
            ...
            p_v_h = sigmoid(np.tile(self.bias_v, (n_samples, 1)) + hidden_minibatch @ self.weight_vh.T)

            #calculate v
            v = sample_binary(p_v_h)

        assert p_v_h.shape == (n_samples, self.ndim_visible), p_v_h.shape
        return p_v_h, v
